...
public class SellerListController implements Initializable, DataChangeListener {
	...
	// Declara uma dependencia com o SellerService
	...
	private void initializeNodes() {
		...
		// Objeto Window, que é retornado pela getWindow(), é uma superclasse de Stage,
	...
	// Método responsável por acessar o serviço, carregar os departamentos e joga-lo
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		/*try {
			...
			// Pegar uma referencia p/o controlador e injeta o Seller
			...
			// Quando carregamos uma janela em frente a uma janela já existente, temos que
